...
\begin{align}
EP_{RS1,extL}(s,\beta) &= e^{I\cdot \theta_{extL}(s)} \prod_{p=2}^{P \le (\lfloor\beta\cdot\sqrt{(\frac{t}{2\pi})^d\cdot N_C}\rfloor)} F_{p,L}(p^{-(s)})^{-1}  \\
EP_{RS2,extL}(s,\beta) &= e^{I\cdot \theta_{extL}(s)}\cdot\mychi(s) \cdot \prod_{p=2}^{P\le(\lfloor\beta\cdot\sqrt{(\frac{t}{2\pi})^d\cdot N_C}\rfloor)} F_{p,L}(p^{-(k-s)})^{-1} 
\end{align}
...
For the case of a L-function using both $EP_{RS1,extL}(s,\beta)$ and $EP_{RS2,extL}(s,\beta)$ calculations
...
\begin{align}
\theta_{normext\mychi{(3,2)}}(s) &= -\frac{1}{2}imag\left[(1/2-s)\cdot \log(3)+(s-1/2)\cdot\log(\pi)+\text{lngamma}((2-s)/2)-\text{lngamma(s+1)}\right]
\end{align}
...
\begin{align}
Z_{extL(\mychi{(3,2)})}(s)_{EP} &\approx EP_{RS1,extL(\mychi{(3,2)})}(s,\beta=1.25) \nonumber \\ &+ EP_{RS2,extL(\mychi{(3,2)})}(s,\beta=1.25) + ... \qquad t \rightarrow \infty
\end{align}
...
(lefthand panel top row); $EP_{RS1,extL(\mychi{(3,2)})}(s,\beta=1.25)$

(lefthand panel middle row); $Z_{L(\mychi{(3,2)})}(s)$ - true Riemann-Siegel Z function

(lefthand panel bottom row); $EP_{RS2,extL(\mychi{(3,2)})}(s,\beta=1.25)$
...
dfZ=read.csv("/home/john/pari/aboutrealaxis/ZL32_res_p5_0_m750_p750_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfZ$V2=as.numeric(gsub(" ","",dfZ$V2));
dfZ=dfZ[order(as.numeric(dfZ$V1)),]

dfZi=read.csv("/home/john/pari/aboutrealaxis/ZL32_res_p5_0_m750_p750_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p5_0_m750_p750_23upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p5_0_m750_p750_23upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p5_0_m750_p750_23upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p5_0_m750_p750_23upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p5_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p5_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p5_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p5_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p5_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p5_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p5_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p5_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p5_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p5_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p5_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p5_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p5_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p5_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p5_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p5_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfZ=read.csv("/home/john/pari/aboutrealaxis/ZL32_res_p9_0_m750_p750_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfZ$V2=as.numeric(gsub(" ","",dfZ$V2));
dfZ=dfZ[order(as.numeric(dfZ$V1)),]

dfZi=read.csv("/home/john/pari/aboutrealaxis/ZL32_res_p9_0_m750_p750_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfZi$V2=as.numeric(gsub(" ","",dfZi$V2));
dfZi=dfZi[order(as.numeric(dfZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p9_0_m750_p750_23upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p9_0_m750_p750_23upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p9_0_m750_p750_23upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p9_0_m750_p750_23upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p9_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p9_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p9_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p9_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p9_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p9_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p9_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p9_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p9_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p9_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p9_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p9_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p9_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p9_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p9_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p9_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfZ=read.csv("/home/john/pari/aboutrealaxis/ZL32_res_p1_0_m750_p750_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfZ$V2=as.numeric(gsub(" ","",dfZ$V2));
dfZ=dfZ[order(as.numeric(dfZ$V1)),]

dfZi=read.csv("/home/john/pari/aboutrealaxis/ZL32_res_p1_0_m750_p750_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfZi$V2=as.numeric(gsub(" ","",dfZi$V2));
dfZi=dfZi[order(as.numeric(dfZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p1_0_m750_p750_23upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p1_0_m750_p750_23upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p1_0_m750_p750_23upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p1_0_m750_p750_23upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p1_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p1_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p1_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p1_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p1_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p1_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p1_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p1_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p1_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p1_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p1_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p1_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p1_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32plus_EP_res_p1_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p1_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/ZL32minus_EP_res_p1_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
\begin{align}
\theta_{normextL13.4.a.a}(s) &= -\frac{1}{2}imag\left[\log\left(log(13)\cdot (2-s)+log(2\pi)\cdot (2(s-2))+\text{lngamma}(4-s)-\text{lngamma}(s)\right)\right] 
\end{align}
...
\begin{align}
Z_{extL13.4.a.a}(s)_{EP} &\approx EP_{RS1,extL_{13.4.a.a}}(s,\beta=1.25) \nonumber \\ &+ EP_{RS2,extL_{13.4.a.a}}(s,\beta=1.25) + ... \qquad t \rightarrow \infty
\end{align}
...
(i) $s=(2-I\cdot 750,2+I\cdot 750)$, 

(ii) $s=(2.3-I\cdot 750,2.3+I\cdot 750)$ and 

(iii) $s=(1.7-I\cdot 750,1.7+I\cdot 750)$ 

display the individual fourier transforms of the spectra of the two components of the zeroth order Riemann-Siegel formula approximation of the Riemann-Siegel Z function using partial Euler Products truncated at the first quiescent region as defined in equation (16). Shown in the

(lefthand panel top row); $EP_{RS1,extL_{13.4.a.a}}(s,\beta=1.25)$

(lefthand panel middle row); $Z_{L_{13.4.a.a}}(s)$ - true Riemann-Siegel Z function

(lefthand panel bottom row); $EP_{RS2,extL_{13.4.a.a}}(s,\beta=1.25)$
...
is displayed for 3 different values of the minimum prime in partial Euler product calculation $P_{min}=\left\lfloor \max\left(\{1,2,3\},1.25\cdot \sqrt{(\frac{t}{2\pi})^d\cdot N_C}\right)\right\rfloor$ with each row (top to bottom) respectively belonging to the minimum prime value \{1,2,3\} which is active when t=0.

In the lefthand panels of figure 9 the same interval 

(i) $s=(2-I\cdot 40,0.5+I\cdot 40)$

is displayed for 3 different values of the minimum prime in partial Euler product calculation $P_{min}=\left\lfloor \max\left(\{50, 430, 537\},1.25\cdot \sqrt{(\frac{t}{2\pi})^d\cdot N_C}\right)\right\rfloor$ with each row (top to bottom) respectively belonging to the minimum prime value \{50, 430, 537\} which is active when t=0. 

In the lefthand panels of figures 11 and 13 the following interval is displayed for four different values of the minimum prime in partial Euler product calculation $P_{min}=\left\lfloor \max\left(\{1,2,50,537\},1.25\cdot \sqrt{(\frac{t}{2\pi})^d\cdot N_C}\right)\right\rfloor$ with each row (top to bottom) respectively belonging to the minimum prime value \{1,2,50,537\} which is active when t=0.
...
dfZ=read.csv("/home/john/pari/aboutrealaxis/Z13p4aa_res_2p_0_m750_p750_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfZ$V2=as.numeric(gsub(" ","",dfZ$V2));
dfZ=dfZ[order(as.numeric(dfZ$V1)),]

dfZi=read.csv("/home/john/pari/aboutrealaxis/Z13p4aa_res_2p_0_m750_p750_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfZi$V2=as.numeric(gsub(" ","",dfZi$V2));
dfZi=dfZi[order(as.numeric(dfZi$V1)),]
...
#using minimum 23 primes in prodeuler pari-gp function
 ...
 dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p_0_m750_p750_537upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
 dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
 dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]
 
 dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p_0_m750_p750_537upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
 dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
 dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
 ...
 dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p_0_m750_p750_537upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
 dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
 dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]
 
 dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p_0_m750_p750_537upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
 dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
 dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p_0_m750_p750_50upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p_0_m750_p750_50upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p_0_m750_p750_50upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p_0_m750_p750_50upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p_0_m750_p750_430upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p_0_m750_p750_430upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p_0_m750_p750_430upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p_0_m750_p750_430upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfZ=read.csv("/home/john/pari/aboutrealaxis/Z13p4aa_res_2p3_0_m750_p750_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfZ$V2=as.numeric(gsub(" ","",dfZ$V2));
dfZ=dfZ[order(as.numeric(dfZ$V1)),]

dfZi=read.csv("/home/john/pari/aboutrealaxis/Z13p4aa_res_2p3_0_m750_p750_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfZi$V2=as.numeric(gsub(" ","",dfZi$V2));
dfZi=dfZi[order(as.numeric(dfZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p3_0_m750_p750_537upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p3_0_m750_p750_537upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p3_0_m750_p750_537upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p3_0_m750_p750_537upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p3_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p3_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p3_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p3_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p3_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p3_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p3_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p3_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p3_0_m750_p750_50upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_2p3_0_m750_p750_50upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p3_0_m750_p750_50upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_2p3_0_m750_p750_50upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfZ=read.csv("/home/john/pari/aboutrealaxis/Z13p4aa_res_1p7_0_m750_p750_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfZ$V2=as.numeric(gsub(" ","",dfZ$V2));
dfZ=dfZ[order(as.numeric(dfZ$V1)),]

dfZi=read.csv("/home/john/pari/aboutrealaxis/Z13p4aa_res_1p7_0_m750_p750_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfZi$V2=as.numeric(gsub(" ","",dfZi$V2));
dfZi=dfZi[order(as.numeric(dfZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_1p7_0_m750_p750_537upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_1p7_0_m750_p750_537upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_1p7_0_m750_p750_537upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_1p7_0_m750_p750_537upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
```{r Zfn13p4aaModularFormLfunctionoveraninterval_anditsfouriertransform_0_pm750_1p7, echo=FALSE, fig.cap="Lefthand panel - True Z function shown in magenta (cyan) for real (imaginary) parts and spectral filtered based EP approximation shown in black (blue) for real (imaginary) parts, Right hand panel - Error in the real(Z) EP approximation. A comparison of the Riemann-Siegel Z function analogue of the L-function 2-13-1.1-c3-0-2 (LMFDB label) and spectrally filtered partial Euler Product (using truncation at $\\max (P,1.25\\cdot\\sqrt{((\\frac{t}{2\\pi})^2\\cdot 13}) $) in the complex plane at $\\sigma=1.7$ for the interval t=(-750,750) where $P_{min}={1,2,50,537}$ for rows 1-4. ", out.width = c("49%","49%"), fig.show = "hold",  fig.height=4.5, warning=FALSE, cache=TRUE}
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_1p7_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_1p7_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_1p7_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_1p7_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_1p7_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_1p7_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_1p7_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_1p7_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_1p7_0_m750_p750_50upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus13p4aa_EP_res_1p7_0_m750_p750_50upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_1p7_0_m750_p750_50upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus13p4aa_EP_res_1p7_0_m750_p750_50upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
\begin{align}
Z_{ext\zeta}(s)_{EP} &\approx EP_{RS1,ext\zeta}(s,\beta=1.25) \nonumber \\ &+ EP_{RS2,ext\zeta}(s,\beta=1.25) + ... \qquad t \rightarrow \infty
\end{align}
...
```{r Zfnzeta_andtruncatedEPfouriertransform_0_pm750, echo=FALSE, fig.cap="Lefthand panel - True Z function shown in magenta (cyan) for real (imaginary) parts and spectral filtered based EP approximation shown in black (blue) for real (imaginary) parts, Right hand panel - Error in the real(Z) EP approximation. A comparison of the Riemann-Siegel Z function of the Riemann Zeta L-function and spectrally filtered partial Euler Product (using truncation at $\\max (P,1.25\\cdot\\sqrt{((\\frac{t}{2\\pi})^1\\cdot 1}) $) in the complex plane at $\\sigma=0.5$ for the interval t=(-750,750) where $P_{min}={1,2,3,5,13}$ for rows 1-5. The approximation error around t=0 does not disappear by adding primes.", out.width = c("49%","49%"), fig.show = "hold",  fig.height=3.8, warning=FALSE, cache=TRUE}
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p5_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p5_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p5_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p5_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p5_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p5_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p5_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p5_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p5_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p5_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p5_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p5_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p5_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p5_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p5_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p5_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
```{r Zfnzeta_andtruncatedEPfouriertransform_0_pm750_p1, echo=FALSE, fig.cap="Lefthand panel - True Z function shown in magenta (cyan) for real (imaginary) parts and spectral filtered based EP approximation shown in black (blue) for real (imaginary) parts, Right hand panel - Error in the real(Z) EP approximation. A comparison of the Riemann-Siegel Z function of the Riemann Zeta L-function and spectrally filtered partial Euler Product (using truncation at $\\max (P,1.25\\cdot\\sqrt{((\\frac{t}{2\\pi})^1\\cdot 1}) $) in the complex plane at $\\sigma=0.1$ for the interval t=(-750,750) where $P_{min}={1,2,3,5,13}$ for rows 1-5. The approximation error around t=0 only increases by adding primes.", out.width = c("49%","49%"), fig.show = "hold",  fig.height=3.8, warning=FALSE, cache=TRUE}

# Riemann-Siegel Z function of Riemann Zeta function on critical line
# values recorded every .01 spacing in interval [-750,+750]

dfZ=read.csv("/home/john/pari/aboutrealaxis/Zzeta_res_p1_0_m750_p750_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfZ$V2=as.numeric(gsub(" ","",dfZ$V2));
dfZ=dfZ[order(as.numeric(dfZ$V1)),]

dfZi=read.csv("/home/john/pari/aboutrealaxis/Zzeta_res_p1_0_m750_p750_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfZi$V2=as.numeric(gsub(" ","",dfZi$V2));
dfZi=dfZi[order(as.numeric(dfZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p1_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p1_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p1_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p1_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p1_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p1_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p1_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p1_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p1_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p1_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p1_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p1_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p1_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p1_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p1_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p1_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p1_0_m750_p750_13upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p1_0_m750_p750_13upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p1_0_m750_p750_13upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p1_0_m750_p750_13upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p9_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p9_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p9_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p9_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p9_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p9_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p9_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p9_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p9_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p9_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p9_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p9_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p9_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EPonly_res_p9_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p9_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EPonly_res_p9_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p5_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p5_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p5_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p5_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p5_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p5_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p5_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p5_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p5_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p5_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p5_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p5_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p5_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p5_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p5_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p5_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p5_0_m750_p750_13upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p5_0_m750_p750_13upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p5_0_m750_p750_13upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p5_0_m750_p750_13upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p1_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p1_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p1_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p1_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p1_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p1_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p1_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p1_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p1_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p1_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p1_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p1_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p1_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p1_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p1_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p1_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p1_0_m750_p750_13upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p1_0_m750_p750_13upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p1_0_m750_p750_13upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p1_0_m750_p750_13upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p9_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p9_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p9_0_m750_p750_0extra_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p9_0_m750_p750_0extra_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p9_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p9_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p9_0_m750_p750_2upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p9_0_m750_p750_2upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p9_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p9_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p9_0_m750_p750_3upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p9_0_m750_p750_3upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p9_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p9_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p9_0_m750_p750_5upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p9_0_m750_p750_5upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
...
dfplusZ=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p9_0_m750_p750_13upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfplusZ$V2=as.numeric(gsub(" ","",dfplusZ$V2));
dfplusZ=dfplusZ[order(as.numeric(dfplusZ$V1)),]

dfplusZi=read.csv("/home/john/pari/aboutrealaxis/Zplus_EP_res_p9_0_m750_p750_13upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfplusZi$V2=as.numeric(gsub(" ","",dfplusZi$V2));
dfplusZi=dfplusZi[order(as.numeric(dfplusZi$V1)),]
...
dfminusZ=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p9_0_m750_p750_13upwards_spacing_p01_real.csv",header=FALSE,colClasses = c("character"));
dfminusZ$V2=as.numeric(gsub(" ","",dfminusZ$V2));
dfminusZ=dfminusZ[order(as.numeric(dfminusZ$V1)),]

dfminusZi=read.csv("/home/john/pari/aboutrealaxis/Zminus_EP_res_p9_0_m750_p750_13upwards_spacing_p01_imag.csv",header=FALSE,colClasses = c("character"));
dfminusZi$V2=as.numeric(gsub(" ","",dfminusZi$V2));
dfminusZi=dfminusZi[order(as.numeric(dfminusZi$V1)),]
