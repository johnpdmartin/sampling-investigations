...
hist(boot.out$t,breaks=60,xlim=c(.4,.8),main="Bootstrap resamples of median",xaxt="n",sub="Fig. 3a",xlab="bootstrap median sample values",ylab="frequency of values",)
medianest <- mean(boot.out$t)
axis(1, at=seq(.4,.8,.02), label=F, tick=T, tck=-.02)
axis(1, at=seq(.4,.8,.05), tck=-.04)
...
hist(jkexpand,breaks=40,xlim=c(.4,.8),main="Drop one unit Jackknife subsamples of median using original scale",xaxt="n",sub="Fig. 3b",xlab="jackknife median sample values",ylab="frequency of values",)
...
hist(jkexpandinv,breaks=40,xlim=c(.4,.8),main="Drop one unit Jackknife subsamples of median using percentile scale",xaxt="n",sub="Fig. 3c",xlab="jackknife median sample values",ylab="frequency of values",)
