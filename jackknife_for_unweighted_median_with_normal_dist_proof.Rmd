...
\begin{equation}\frac{1}{n}\cdot((floor(\frac{n}{2})+1)jk\_lower+floor(\frac{n}{2})jk\_upper) = \frac{1}{n}jk\_lower\end{equation}

\begin{equation}\approx \frac{1}{2n}-\frac{1}{2n^{2}}+...\end{equation}
...
\begin{equation}= \frac{n-1}{n}\cdot ((floor(\frac{n}{2})+1)\cdot((jk\_lower-\frac{1}{2})^{2}+(floor(\frac{n}{2})\cdot(jk\_upper-\frac{1}{2})^{2}))\end{equation}

\begin{equation}\approx \frac{n-1}{n}\cdot(2\cdot floor(\frac{n}{2})+1)\cdot(\frac{1}{2n}+\frac{1}{2n^{2}}+...)^{2}\end{equation}

\begin{equation}\approx \frac{n-1}{n}\cdot n\cdot(\frac{1}{2n}+\frac{1}{2n^{2}}+...)^{2}\end{equation}
