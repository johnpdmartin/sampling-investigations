...
\begin{equation}jk\_lower = (floor(\frac{n}{2})-1)\cdot\frac{1}{n-1}\end{equation}  
...
\begin{equation}\approx \frac{1}{2}\cdot(1+\frac{1}{n}+\frac{1}{n^{2}}+...)\end{equation}
...
\begin{equation}\frac{1}{n}\cdot((floor(\frac{n}{2})+1)jk\_lower+floor(\frac{n}{2})jk\_upper) = \frac{1}{n}\cdot (n\cdot\frac{1}{2}-\frac{1}{2n}-\frac{1}{2n^{2}})\end{equation}

\begin{equation}\approx \frac{1}{2}-\frac{1}{2n^{2}}-\frac{1}{2n^{3}}+...\end{equation}

which differs from the full sample median estimate

\begin{equation}\therefore bias\_jk\_n\_odd \approx -\frac{n-1}{2n^{2}}+...\end{equation}
...
\begin{equation}= \frac{n-1}{n}\cdot ((floor(\frac{n}{2})+1)\cdot((jk\_lower-\frac{1}{2}+\frac{1}{2n^{2}})^{2}+(floor(\frac{n}{2})\cdot(jk\_upper-\frac{1}{2}+\frac{1}{2n^{2}})^{2}))\end{equation}

\begin{equation}\approx \frac{n-1}{n}\cdot(2\cdot floor(\frac{n}{2})+1)\cdot(\frac{1}{2n}+...)^{2}\end{equation}

\begin{equation}\approx \frac{n-1}{n}\cdot n\cdot(\frac{1}{2n}+...)^{2}\end{equation}
...
hist(boot.out$t,breaks=60,xlim=c(.42,.56),main="Bootstrap resamples of median",xaxt="n",sub="Fig. 3a",xlab="bootstrap median sample values",ylab="frequency of values",)
...
hist(jkexpand,breaks=40,xlim=c(.42,.56),main="Drop one unit Jackknife subsamples of median using original scale",xaxt="n",sub="Fig. 3b",xlab="jackknife median sample values",ylab="frequency of values",)
...
hist(jkexpandinv,breaks=40,xlim=c(.42,.56),main="Drop one unit Jackknife subsamples of median using percentile scale",xaxt="n",sub="Fig. 3c",xlab="jackknife median sample values",ylab="frequency of values",)
