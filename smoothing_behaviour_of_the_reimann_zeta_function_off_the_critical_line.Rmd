...
The closeness of the smoothing behaviour of the Riemann Zeta function and the rescaled Riemann Siegel function has also been confirmed with higher precision using Julia language code.
...
hist(res1,breaks=1000)
plot(x,fat1+res1)
points(x,fat1,col="red")
print(paste(max(res1),min(res1),min(res1)/max(fat1)))
hist(res2,breaks=1000)
plot(x,fat2+res2)
points(x,fat2,col="red")
print(paste(max(res2),min(res2),min(res2)/max(fat2)))
hist(res3,breaks=1000)
plot(x,fat3+res3)
points(x,fat3,col="red")
print(paste(max(res3),min(res3),min(res3)/max(fat3)))
