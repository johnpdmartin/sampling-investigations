...
```{r, setwd, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high'}
#setwd("C:/Users/John/Documents/GitHub/sampling-investigations/modelCIheterogeneouscaseresults")
setwd("/home/john/bear/Projects/sampling-investigations/git_repo/sampling-investigations/modelCIheterogeneouscaseresults")
...
the model slope(s) and intercept CI estimates are derived from empirical variance distribution (evd) approximations of the quantile regression residuals sample variance (distribution) $s_{res}^2$ via the relationships

\begin{equation} s_{\beta_1} = \sqrt{\frac{s_{res}^2}{var(x_1)(1-r_{12qr})}}\label{eq:1} \end{equation}

\begin{equation} s_{\beta_2} = \sqrt{\frac{s_{res}^2}{var(x_2)(1-r_{12qr})}}\label{eq:2} \end{equation}
...
Importantly, to keep the evd based variance estimation maximising the use of quantile regression calculations. The residuals distribution variance $s_{res}^2$ is not calculated using sum of squares of errors of the residuals but is calculated by performing quantile regression calculations on the residual distribution using evd based estimates of ($\theta_{LB}$, $\theta_{UB}$), to then estimate the 2.5th & 97.5th bounds in the original measurement scale.   
...
```{r, linearhorn, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, linearhornresiduals, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, linearhornauxiliaryregression, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, linearhornadjustedresiduals, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}
...
\begin{equation} s_{\beta_1} = \sqrt{\frac{s_{residual adjust (max half evd CI)}^2}{var(x)}}\label{eq:slopehet} \end{equation}
...
```{r, xmedianCIlength, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, evdxmedianCIlength, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, reg1slope, echo=FALSE, cache=TRUE, fig.width=6, fig.height=3, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, reg1intercept, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, reg2slope, echo=FALSE, cache=TRUE, fig.width=6, fig.height=3, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, reg2intercept, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, reg3slope, echo=FALSE, cache=TRUE, fig.width=6, fig.height=3, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, reg3slope2, echo=FALSE, cache=TRUE, fig.width=6, fig.height=3, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, reg3intercept, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, engel_log-log, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high',warning=FALSE,message=FALSE}
...
```{r, evd_algorithm, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high',warning=FALSE}
...
```{r, Engel_quasi-homoscedastic, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high',warning=FALSE}
...
```{r, Engel_quasi-homoscedastic_auxreg, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high',warning=FALSE}
...
```{r, engel_heteroscedastic, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high'}
...
```{r, engel_heteroscedastic_auxreg, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high'}
