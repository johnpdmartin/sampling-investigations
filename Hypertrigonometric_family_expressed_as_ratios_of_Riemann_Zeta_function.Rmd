...
2. abs(Re(s)-0.5) <= 0.5, zetatangent(s) has minima at the same Im(s) values for Riemann Zeta critical line zeroes

3. abs(Re(s)-0.5) > 0.5, the positions of at least some of the zetatangent(s) minima are impacted by the Riemann Zeta roots at Re(s)= -2, -4, -6 etc.
