...
\begin{equation}
abs(\zeta(s)) = \sqrt{Z(t)^2+\alpha^2Re(Z)^\prime(t)^2+\beta^2Re(Z)^{\prime\prime}(t) + ....}   \label{eq:serexp}
\end{equation}
...
\begin{equation}
abs(\zeta(s)) \approx A \cdot \sqrt{Re(Z(t))^2+B^2Re(Z)^\prime(t)^2+ B^3Re(Z)^{\prime\prime}(t)^2 + B^4Re(Z)^{\prime\prime\prime}(t)^2+....}   \qquad for \thinspace Re(s) \thinspace < \thinspace 0.5 \label{eq:4thorder}
\end{equation}
