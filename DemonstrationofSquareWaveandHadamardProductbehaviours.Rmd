...
The ratio $\frac{Z_{ext}(\frac{s}{n})^2}{\zeta(\frac{s}{n})}$ can be used to identify the positive odd integers and prime numbers. This function which allows input values off the postive real axis may give useful insights to the prime-counting function. 
