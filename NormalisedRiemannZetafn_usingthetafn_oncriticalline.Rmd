...
lines(x=log(10^xs),y=log(sqrt(((10^xs)^0.1548)*(1))),col=9)
lines(x=log(10^xs),y=log(exp(.57721)*log(log(10^xs))),col=1,lty=3)
points(x=log(scaled_peaks_x),y=log(scaled_peaks_h),pch=4,col=2)
legend("bottomright", c("t^(0.1548)","Theta'(t) based growth","some scaled known zeta peaks","hybrid sqrt(t^(0.1548)*Theta'(t)) based growth","speculative s=1+it growth behaviour?"),
