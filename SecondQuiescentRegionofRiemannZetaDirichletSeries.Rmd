...
The paper shows that simple zeroth and first order expressions using truncation at $N \approx \frac{t}{\pi}$ of the Riemann Zeta Dirichlet series are well behaved and monotonically decreasing. All the calculations and graphs are produced using the pari-gp language [7].
