---
title: Improved jackknife estimates for median variance in equally weighted samples using percentile scale based calculations
...
####Appendix - Results and calculations of bootstrap and jackknife resampling for several continuous distributions  
...
**Figure 4**
```{r, symmetric_distribution_case_2_uniform, echo=FALSE, cache=FALSE, fig.width=6, fig.height=6, fig.keep='high'}
setwd("d:/courses/research/variance")
...
mtext("Median variance and 95% Confidence Interval estimates", side=3, outer=TRUE, line=-1.5)
mtext("symmetric distribution case 3 - systematic unif(0,1)", side=3, outer=TRUE, line=-3)
mtext("red - pop'n value, black - sample median, blue - 2.5%/97.5% CI bounds", side=3, outer=TRUE, line=-5)
