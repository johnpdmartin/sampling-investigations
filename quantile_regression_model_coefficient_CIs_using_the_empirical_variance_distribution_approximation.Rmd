...
the model slope(s) and coefficients are derived from the residuals sample variance (distribution) $s_{res}^2$ via the linear regression relationships

\begin{equation} s_{\beta_1} = \sqrt{\frac{s_{res}^2}{var(x_1)(1-r_{12})}}\label{eq:1} \end{equation}

\begin{equation} s_{\beta_2} = \sqrt{\frac{s_{res}^2}{var(x_2)(1-r_{12})}}\label{eq:2} \end{equation}

\begin{equation} s_{\beta_0} = \sqrt{s_{res}^2+s_{\beta_1}^2\bar{x}_1^2 +s_{\beta_2}^2\bar{x}_2^2 }\label{eq:3} \end{equation}
...
\begin{equation} s_{\beta_0}(\theta) = \sqrt{s_{res}^2+s_{\beta_1}^2 (x_1(\theta))^2 +s_{\beta_2}^2 (x_2(\theta))^2 }\label{eq:4} \end{equation}

\begin{equation} s_{\beta_0}(\theta) = \sqrt{s_{res}^2+s_{\beta_1}^2 median(x_1)^2 +s_{\beta_2}^2 median(x_2)^2 }\label{eq:5} \end{equation}
...
```{r, reg1slope, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}

#setwd("C:/Users/John/Documents/GitHub/sampling-investigations/modelCIhomogeneouscaseresults")
setwd("/home/john/bear/Projects/sampling-investigations/git_repo/sampling-investigations/modelCIhomogeneouscaseresults")
# library("quantreg")
...
```{r, reg2slope, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, reg3slope, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, reg4slope, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, reg4slope2, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, reg4intercept, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, reg5slope, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}
...
```{r, reg5intercept, echo=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.keep='high', message=FALSE, warning=FALSE}
