...
As will be shown graphically, in the positive quadrant of the complex plane above the negative real axis zeroes

\begin{equation}
[\frac{1}{2\pi} (\theta_{ext}(s)) \Big|_{\sigma+i*t}] = \frac{(\theta(t) + 1)}{2}
\end{equation}
...
\begin{cases}
- \frac{(\theta(t) + 1)}{2} \qquad \sigma > 0.5 \label {eq:an_Z} \\
0 \qquad \qquad \qquad \sigma = 0.5 \\
 \frac{(\theta(t) + 1)}{2} \qquad \qquad -2 < \sigma < 0.5 
\end{cases}
\end{equation}
...
\begin{cases}
0 \qquad \sigma > 0.5 \label {eq:an_Z} \\
\frac{(\theta(t) + 1)}{2} \qquad \qquad \qquad \sigma = 0.5 \\
 (\theta(t) + 1) \qquad \qquad -2 < \sigma < 0.5 
\end{cases}
\end{equation}
