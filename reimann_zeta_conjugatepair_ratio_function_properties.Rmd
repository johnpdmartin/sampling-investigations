...
#Riemann Seigal Theta function 

As a precursor to the viewing the lineshapes of $Re(\frac{\zeta (s)}{\zeta (1-s)})$ and $Im(\frac{\zeta (s)}{\zeta (1-s)})$, it is important to revisit the Riemann Seigal function and its Theta and Z components. The Riemann Seigal function is an approximating function (3) for the Riemann Zeta function along the critical line (0.5+it) of the form
...
For values of s away from the critical line, series expansions based around the Riemann Seigal function are employed.

Figure 2, below illustrates the Riemann Seigal function for the critical line alongside the abs($\zeta(0.5+it)$). The lineshape can be understood as a combined modulation signal with a FM and AM terms both depending on t. 
...
plot(x, fa, type="n", xlim = c(minx, maxx), 
     ylim = c(-max(fa), max(fa)),
          xlab = "", ylab = "Function value",
     main = "Riemann Seigal and Riemann Zeta Fns along the critical line")
# lines(x, fr, col="blue")
# lines(x, fi, col="darkgreen")
...
***Figure 2: Riemann Seigal and Riemann Zeta function behaviour on the critical line***
...
points(14.1347, 0, col = "darkred")
legend(0.5, 6, c("real part", "imaginary part", "absolute value"),
       lty = 1,cex=.4, lwd = c(1, 1, 2), col = c("blue", "darkgreen", "red"))
...
lines(x, fat, col="green",lwd=2)
points(14.1347, 0, col = "darkred")
legend(0.5, 60, c("real part", "imaginary part", "absolute value"),
       lty = 1,cex=.4, lwd = c(1, 1, 2), col = c("blue", "darkgreen", "red"))
...
lines(x, fat, col="green",lwd=2)
points(14.1347, 0, col = "darkred")
legend(0.5, 600, c("real part", "imaginary part", "absolute value"),
       lty = 1,cex=.4, lwd = c(1, 1, 2), col = c("blue", "darkgreen", "red"))
grid()## End(Not run)
